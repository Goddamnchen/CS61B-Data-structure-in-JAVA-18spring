public class ArrayDeque<T> implements Deque<T> {
    ...
    @Override
    public int size(){
        /*return the size of occupied array space between sentienls*/
        return size;
    }
    ...
    private void checkUserR(){
        /* check the item.length and usage ratio, if not using memory efficiently, half the space of deque*/
